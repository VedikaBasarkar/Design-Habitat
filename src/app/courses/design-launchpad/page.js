  ...
  return (
    <div className='w-full flex flex-col px-6 lg:px-0'>
      <div className='w-full px-4 lg:px-28 z-0'> 
        <img className='h-vh rounded-b-mobBigBox lg:rounded-b-bigBox' src='https://design-habitat.nyc3.cdn.digitaloceanspaces.com/banners/Offline%20banner%201%20final.png' />
      </div>
      ...
      <div className='mt-10 hidden lg:block border border-y-4 border-r-4 border-dashed border-primary-300 rounded-r-mobBigBox shadow-lg pr-10 py-8 w-fit z-50 bg-white text-secondary-500 '>
        <div className='text-4xl font-mont font-bold pl-20 '>Design Launchpad</div>
        <p className='pl-20 '>by <span className='text-xl'>An exhaustive 2-year Design preparation program offered to learners <br />after completion of Grade 10.</span></p>
        <div className='flex flex-row mt-4 items-center h-fit justify-between'>
          <div className='flex'>
            ...
            <div className='mx-4 font-medium text-lg items-center'>Duration: 2 Years</div>
          </div>
      ...
      mx-4 mt-4 block lg:hidden border-2 p-4 border-dashed border-primary-300 rounded-lg bg-white text-secondary-500'>
        ...
        <div className='text-center'>Duration: 2 Years</div>
      </div>
...
export default DesignLaunchpad;
