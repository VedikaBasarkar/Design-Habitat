  ...
  return (
    <div className='w-full flex flex-col px-6 lg:px-0'>
      <div className='w-full px-4 lg:px-28 z-0'> 
        <img className='h-vh rounded-b-mobBigBox lg:rounded-b-bigBox' src='https://design-habitat.nyc3.cdn.digitaloceanspaces.com/banners/Offline%20banner%203%20final.png' />
      </div>
      ...
      <div className='mt-10 hidden lg:block border border-y-4 border-r-4 border-dashed border-primary-300 rounded-r-mobBigBox shadow-lg pr-10 py-8 w-fit z-50 bg-white text-secondary-500 '>
        ...
        <p className='pl-20 '>by <span className='text-xl'>An exhaustive fast track 1-year Design preparation program offered to learners completing their final year<br /> of graduation or who have completed their graduation.</span></p>
